...
findLeft ::
  ...
  -> ListZipper a
  -> MaybeListZipper a
findLeft p z@(ListZipper _ x _)
  | p x       = IsZ z
  | otherwise = findLeft p -<< moveLeft z
...
findRight ::
  ...
  -> ListZipper a
  -> MaybeListZipper a
findRight p z@(ListZipper _ x _)
  | p x       = IsZ z
  | otherwise = findRight p -<< moveRight z
...
moveRight ::
  ...
  -> MaybeListZipper a
moveRight z
  | hasRight z = IsZ (moveRightLoop z)
  | otherwise  = IsNotZ
